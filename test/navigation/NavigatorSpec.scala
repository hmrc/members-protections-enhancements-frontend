  ...
  "Navigator" - {
    ...
    "in Normal mode" - {
      ...
      "must go from a page that doesn't exist in the route map to Index" in {
        ...
        navigator.nextPage(UnknownPage, NormalMode, UserAnswers("id")) mustBe routes.WhatYouWillNeedController
          .onPageLoad()
      }

      "must go to CheckYourAnswers page" in {

        navigator.nextPage(ResultsPage, NormalMode, UserAnswers("id")) mustBe routes.CheckYourAnswersController
          .onPageLoad()
      }
